...
<div class="row justify-content-between mb-4 me-2">
<div class="col-xl-3 col-md-4 col-12 col-sm-12 bg-light">
<div class="card" style="width: 18rem;">
  <div class="card-body">
    <div class="d-flex justify-content-between">
    <h5 class="card-title">Number of Train</h5><span class="bi bi-train-front "></span>
    </div>
    <h6 class="card-subtitle mt-2 text-center text-muted"><?php echo $nbt_row;   ?></h6>
  </div>
</div>

</div>
<div class="col-xl-2 col-md-4 col-12 col-sm-12 bg-light">
<div class="card" style="width: 18rem;">
  <div class="card-body">
    <div class="d-flex justify-content-between">
    <h5 class="card-title text-success">Train Available</h5><span class="bi bi-train-front text-success"></span>
    </div>
    <h6 class="card-subtitle mt-2 text-center text-muted"><?php echo $nbta_row;   ?></h6>
  </div>
</div>
</div>
...
<div class="card" style="width: 18rem;">
  <div class="card-body">
    <div class="d-flex justify-content-between">
    <h5 class="card-title text-danger">Train Not Available</h5><span class="bi bi-train-front text-danger"></span>
    </div>
    <h6 class="card-subtitle mt-2 text-center text-muted"><?php echo $nbtna_row;   ?></h6>
  </div>
</div>
</div>
...
<div class="row d-flex  justify-content-start ">
        ...
        <form class="me-4"  >
            <div class="input-group mb-3" style="border: 2px solid black;border-radius:8px;">
                <input class="form-control" style="outline: none;"  placeholder="Search" id="search_train" aria-label="Search">
                <button class="input-group-text btn  bi bi-search" type="submit" disabled></button>
            </div>
          </form> 
          </div>
      <div class=" col-xl-5 col-md-4 col-sm-4 col-4 " >
          <div class="input-group">
<button class="btn btn-outline-primary pe-3"   data-bs-toggle="modal" data-bs-target="#add_train">Add train  <span class="bi bi-train-front"></span></button>
          ...
          <!-- end from recherch -->
                ...
                <?php
               //$sql = $conn->query("select * from gl.train");
                //$nb_row = $sql->rowcount();
                if($nbt_row >0) include 'affiche_liste_train.php';
...
if($test==1){
    ...
    if($test==0){
        ...
        if($test==223){
            ...
            <script>
            msg_system_content.classList.add('bg-danger');
            msg_system_content.textContent='You cannot delete this train, see the list of trips !!';
            document.getElementById('btn_msg_h').click();
            document.addEventListener('click',function(){
                window.location='train.php';
            })
            ...
            if($test==224){
                ...
                <script>
                msg_system_content.classList.add('bg-success');
                msg_system_content.textContent='This train has been deleted.';
                document.getElementById('btn_msg_h').click();
                document.addEventListener('click',function(){
                    window.location='train.php';
                })
                ...
                if($test==44){
                    ...
                    <script>
                    msg_system_content.classList.add('bg-danger');
                    msg_system_content.textContent='Error formulaire !!.';
                    document.getElementById('btn_msg_h').click();
                    document.addEventListener('click',function(){
                        window.location='train.php';
                    })
                    ...
                    if($test==33){
                        ...
                        <script>
                        msg_system_content.classList.add('bg-success');
                        msg_system_content.textContent='Welcom in System.';
                        document.getElementById('btn_msg_h').click();
                        document.addEventListener('click',function(){
                            window.location='train.php';
                        })
                        ...
                        if($test==45){
                            ...
                            <script>
                            msg_system_content.classList.add('bg-success');
                            msg_system_content.textContent='This train Not Available,see the list of trips !!';
                            document.getElementById('btn_msg_h').click();
                            document.addEventListener('click',function(){
                                window.location='train.php';
                            })
                                ...
                                <script>
                                msg_system_content.classList.add('bg-success');
                                msg_system_content.textContent='Mail sending ';
                                document.getElementById('btn_msg_h').click();
                                document.addEventListener('click',function(){
                                    window.location='train.php';
                                })
