                ...
                <a href="train.php" class="list-group-item list-group-item-action  active " >
                    <i class="bi bi-train-freight-front me-3"></i>----- Train -----</a>
                         ...
                         <div class="list-group list-group-flush my-2 color_text_ui  ">
                            <a href="#" class="list-group-item list-group-item-action active" style="background-color: #172F46;"><i
...
<div class="card" style="width: 18rem;">
  <div class="card-body">
    ...
    <h5 class="card-title">Number of Trip</h5><span class="bi bi-geo-alt-fill "></span>
    </div>
...
<div class="card" style="width: 18rem;">
  <div class="card-body">
    <div class="d-flex justify-content-between">
    <h5 class="card-title text-success">Trip Available</h5><span class="bi bi-geo-alt-fill text-success"></span>
    </div>
...
<div class="card" style="width: 18rem;">
  <div class="card-body">
    <div class="d-flex justify-content-between">
    <h5 class="card-title text-danger">Trip Problem</h5><span class="bi bi-geo-alt-fill text-danger"></span>
    </div>
...
<div class="row d-flex  justify-content-start ">
        ...
        <form class="me-4"  >
            <div class="input-group mb-3" style="border: 2px solid black;border-radius:8px;">
                <input class="form-control" style="outline: none;"  placeholder="Search" id="search_trip" aria-label="Search">
...
<button class="btn btn-outline-primary pe-3"   data-bs-toggle="modal" data-bs-target="#add_trip">Add Trip   <span class="bi bi-geo-alt-fill"></span></button>
          ...
          <!-- end from recherch -->
              ...
              // $sql = $conn->query("select * from gl.train");
                //$nb_row = $sql->rowcount();
                if($nbt_row >0) include 'affiche_liste_trip.php';
    ...
    if($test_e==0){
        ...
        if($test_e==44){
            ...
            document.addEventListener('click',function(){
                ...
                <script>
                msg_system_content.classList.add('bg-danger');
                msg_system_content.textContent='You cannot delete this trip, This trip was developed !!.';
                document.getElementById('btn_msg_h').click();
                document.addEventListener('click',function(){
                    window.location='trip.php';
                })
